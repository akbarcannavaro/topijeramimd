...
// SILAHKAN TAPI TOLONG JANGAN HAPUS SALAH SATU NAMA DI ATAS ITU
         ...
         case 'developer': case 'dev': {
         	reply(`TOPI JERAMI-BOT DEVELOPER\n\n\n©2021-2023 AKBAR D TRAFALGARR.\n\nWhatshapp\nAKBAR: wa.me/6281906903200`)
         }
         break
case 'delprem':
...
case 'jadian': {
	...
	let jodoh = member[Math.floor(Math.random() * member.length)]
	let jawab = `Ciee yang Jadian Jangan lupa dosanya ya
...
case 'piatu':{
	...
	alpha.sendMessage(from, { text: `anak ${command} Lu @${org.split('@')[0]}`, mentions: [org] }, { quoted: m })
	}
	break
	case 'goblok':
	case 'gblk':
